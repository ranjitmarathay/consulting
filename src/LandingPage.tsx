...
const TextMeButton = () => {
    ...
    const handleClick = () => {
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            ...
            window.open(`sms:${phoneNumber}?body=${encodeURIComponent(emailMessage)}`);
        } else {
    ...
    return (
        ...
        >
            <AppBar position="static" sx={{ bgcolor: 'white', boxShadow: '0 4px 2px -2px gray', borderColor: "#000000" }}>
                <Toolbar>
                    <Typography fontSize={34} fontWeight={800} color={"#000000"}>
                        Ranjit Marathay
                    </Typography>
                </Toolbar>
            </AppBar>            
            ...
            >
                ...
                <Grid item xs={12}>
                    ...
                    <Box sx={{paddingLeft: "30px", paddingBottom: "25px"}}>
                        <Box
                            sx={{
                                textAlign: "left",
                                paddingTop: "10px",
